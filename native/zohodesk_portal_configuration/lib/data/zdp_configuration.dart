...
class ZDPConfiguration {
  ...
  bool _isBusinessMessengerEnabled = true;
  ...
  set isBusinessMessengerEnabled(bool isEnabled) => _isBusinessMessengerEnabled = isEnabled;
  ...
  bool get isBusinessMessengerEnabled => _isBusinessMessengerEnabled;
  ...
  Map toJson() => {
    ...
    'isBusinessMessengerEnabled' : isBusinessMessengerEnabled,
